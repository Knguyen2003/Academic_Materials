...
@NamedNativeQueries({
	@NamedNativeQuery(name="Course.findCoursesWithMaxCredits", query = "select * from [dbo].[Course] c where c.credits >= (select max(credits) from Course)",resultClass = Course.class)
})
